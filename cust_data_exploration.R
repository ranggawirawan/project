...
ggplot(custdata2) + geom_bar(aes(x=marital.stat), position="dodge", fill="green") +facet_wrap(~housing.type, scales="free_y") + theme(axis.text.x = element_text(angle = 45, hjust = 1))